...
namespace backend.Migrations
{
    ...
    [Migration("20251123033136_add-user-to-comment2")]
    partial class addusertocomment2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("backend.Models.DefaultUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("backend.Models.Portfolio", b =>
                {
                    ...
                    b.HasKey("DefaultUserId", "CompanyStockId");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("backend.Models.DefaultUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("backend.Models.Comment", b =>
                {
                    ...
                    b.HasOne("backend.Models.DefaultUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("backend.Models.Portfolio", b =>
                {
                    ...
                    b.HasOne("backend.Models.DefaultUser", "DefaultUser")
                        .WithMany("Portfolios")
